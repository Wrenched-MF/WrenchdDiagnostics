...
import { ArrowLeft, Download, Mail, FileText, Eye } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black p-4">
        ...
        <div className="grid gap-6">
          {reports.length === 0 ? (
            ...
            reports.map((report: Report) => (
              <Card key={report.id} className="bg-black border border-green-500/30 hover:border-green-400/50 transition-colors">
                <CardHeader>
      ...
      <Dialog open={emailDialogOpen} onOpenChange={setEmailDialogOpen}>
        <DialogContent className="bg-black border border-green-500/30 text-green-100 max-w-md">
          <DialogHeader>
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                className="bg-gray-800 border-green-500/40 text-green-100"
            ...
            <div>
              ...
              <Textarea
                ...
                className="bg-gray-800 border-green-500/40 text-green-100 h-32 resize-none"
              />
            </div>
            <div className="flex space-x-3">
              <TouchButton
